...
data_arg.add_argument(
    "--num_classes", type=int, default=100, help="Number of classes to classify"
)
data_arg.add_argument(
...
train_arg.add_argument(
    "--init_lr", type=float, default=0.1, help="Initial learning rate value"
)
train_arg.add_argument(
    "--weight_decay",
    type=float,
...
train_arg.add_argument(
    "--nesterov", type=str2bool, default=True, help="Whether to use Nesterov momentum"
)
train_arg.add_argument(
    "--lr_patience",
    type=int,
...
train_arg.add_argument(
    "--gamma", type=float, default=0.1, help="value of learning rate decay"
)
...
misc_arg.add_argument(
    "--save_name", type=str, default="model", help="Name of the model to save as"
)
misc_arg.add_argument(
    "--model_num", type=int, default=2, help="Number of models to train for DML"
)
