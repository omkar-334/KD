...
def branchBottleNeck(channel_in, channel_out, kernel_size):
    ...
    return nn.Sequential(
        ...
        nn.ReLU(),
        nn.Conv2d(
            middle_channel, middle_channel, kernel_size=kernel_size, stride=kernel_size
        ),
        nn.BatchNorm2d(middle_channel),
        nn.ReLU(),
...
class Multi_ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.bottleneck1_1 = branchBottleNeck(
            64 * block.expansion, 512 * block.expansion, kernel_size=8
        )
        ...
        self.bottleneck2_1 = branchBottleNeck(
            128 * block.expansion, 512 * block.expansion, kernel_size=4
        )
        ...
        self.bottleneck3_1 = branchBottleNeck(
            256 * block.expansion, 512 * block.expansion, kernel_size=2
        )
